  ...
  skills: z
    .object({
      art: z
        .object(
          ARTS.reduce(
            (acc: { [art: string]: z.ZodOptional<z.ZodNumber> }, art) => {
      ...
      knowledge: z
        .object(
          KNOWLEDGES.reduce(
            (
              acc: { [knowledge: string]: z.ZodOptional<z.ZodNumber> },
              knowledge
            ) => {
      ...
      intellect: z
        .object(
          INTELLECTS.reduce(
            (
              acc: { [intellect: string]: z.ZodOptional<z.ZodNumber> },
              intellect
            ) => {
      ...
      physical: z
        .object(
          PHYSICALS.reduce(
            (
              acc: { [physical: string]: z.ZodOptional<z.ZodNumber> },
              physical
            ) => {
      ...
      social: z
        .object(
          SOCIALS.reduce(
            (acc: { [social: string]: z.ZodOptional<z.ZodNumber> }, social) => {
      ...
      survival: z
        .object(
          SURVIVALS.reduce(
            (
              acc: { [survival: string]: z.ZodOptional<z.ZodNumber> },
              survival
            ) => {
