        ...
        <main>
            <React.Fragment>
                ...
                <Paper variant="outlined" sx={{  p: { xs: 2, md: 3 }, m: { xs: 0, md: "0 40px"} }}>
                    <Stack sx={{ position: "fixed", left: 0, zIndex: 5, top: "9%", width: '100%', display: { xs: 'none', md: 'block' }, borderTop: "5px solid black" }}>
                        <Tabs aria-label="Flex auto tabs">
                            <TabList tabFlex="auto">
                                {character && menu.map((item, index) => (
                                    <Tab key={index}>
                                        <Typography key={index} onClick={() => setSelection(item)}>{item.label}</Typography>
                                    </Tab>
                                ))}
                            </TabList>
                        </Tabs>
                    </Stack>
                    <IconButton variant="outlined" color="neutral" onClick={() => setState(true)} sx={{
                            ...
                            >
                                ...
                                >
                                    ...
                                    <AspectRatio
                                        ratio="1"
                                        maxHeight={150}
                                        sx={{ width: 150, borderRadius: '100%', margin: 'auto', border: '2px solid white', alignSelf: 'center'}}
                                    >
                                    ...
                                    <Typography level="body-sm" fontWeight="lg" textColor="text.tertiary">
                                        {character.race}{character.type && ` (${character.type})`} | {character.class}
                                    </Typography>
                                    <Typography level="body-sm" fontWeight="lg" textColor="text.tertiary">
