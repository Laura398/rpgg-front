...
import {
  FIRSTNAMES,
  LASTNAMES,
} from "../../../types/Character.names.constants";
...
import {
  ...
  SOCIAL_STATUSES,
  TYPES_FOR_HALFLINGS,
  TYPES_FOR_LUTINS_FEMALES,
  TYPES_FOR_LUTINS_MALES,
...
export default function GeneralInfos(props: {
  ...
  setAlertSeverity: (alertSeverity: string) => void;
}) {
  ...
  const randomSocialStatus = () => {
    ...
    setGeneralInfos({
      ...generalInfos,
      socialStatus: SOCIAL_STATUSES[randomIndex],
    });
  };
  ...
  const randomFamilySituation = () => {
    ...
    setGeneralInfos({
      ...generalInfos,
      familySituation: FAMILY_SITUATIONS[randomIndex],
    });
  };
  ...
  const randomAll = async () => {
    ...
    characterData.sexuality =
      SEXUALITIES[Math.floor(Math.random() * SEXUALITIES.length)];
    ...
    characterData.socialStatus =
      SOCIAL_STATUSES[Math.floor(Math.random() * SOCIAL_STATUSES.length)];
    characterData.familySituation =
      FAMILY_SITUATIONS[Math.floor(Math.random() * FAMILY_SITUATIONS.length)];
    characterData.class = await defineRandomClass(characterData.race);
    characterData.height = defineHeight(
      characterData.race,
      characterData.gender
    );
    characterData.weight = defineWeight(
      characterData.race,
      characterData.gender
    );
    ...
    if (RACES_NEED_TYPE.includes(randomRace as any)) {
      ...
      if (characterData.race === "Lutin") {
        if (characterData.gender === "Femme") {
          ...
          randomType =
            TYPES_FOR_LUTINS_FEMALES[
              Math.floor(Math.random() * TYPES_FOR_LUTINS_FEMALES.length)
            ];
        } else {
          setTypesList([...TYPES_FOR_LUTINS_MALES]);
          randomType =
            TYPES_FOR_LUTINS_MALES[
              Math.floor(Math.random() * TYPES_FOR_LUTINS_MALES.length)
            ];
        }
        ...
        randomType =
          TYPES_FOR_HALFLINGS[
            Math.floor(Math.random() * TYPES_FOR_HALFLINGS.length)
          ];
      } else {
        setTypesList([...sortedAnimals]);
        randomType =
          sortedAnimals[Math.floor(Math.random() * sortedAnimals.length)];
      }
    } else {
      setNeedsType(false);
    }
  ...
  const save = async () => {
    if (props.edit) {
      ...
      if (createdCharacter._id)
        navigate("/character/" + createdCharacter._id + "/edit");
  ...
  const inputsList = [
    {
      ...
      startDecorator: <CasinoIcon onClick={randomFirstName} />,
    },
    {
      name: "lastname",
      placeholder: "Nom",
      ...
      startDecorator: <CasinoIcon onClick={randomLastName} />,
    },
    {
      name: "nickname",
      placeholder: "Surnom",
    ...
    },
    {
      ...
      startDecorator: <CasinoIcon onClick={randomHeight} />,
    },
    {
      name: "weight",
      ...
      startDecorator: <CasinoIcon onClick={randomWeight} />,
    },
    {
      name: "eyesColor",
      ...
      startDecorator: <CasinoIcon onClick={randomEyesColor} />,
    },
    {
      name: "hairColor",
      ...
      startDecorator: <CasinoIcon onClick={randomHairColor} />,
    },
  ];

  const defineSelectsList = () =>
    setSelectsList([
      {
        name: "gender",
        placeholder: "Genre",
        ...
        startDecorator: <CasinoIcon onClick={randomGender} />,
        options: GENDERS,
      },
      {
        name: "sexuality",
        placeholder: "Sexualité",
        onChange: changeSelect,
        value: generalInfos.sexuality || "Sexualité",
        startDecorator: <CasinoIcon onClick={randomSexuality} />,
        options: SEXUALITIES,
      },
      {
        name: "children",
        ...
        startDecorator: <CasinoIcon onClick={randomChildren} />,
        options: children,
      },
      {
        ...
        startDecorator: <CasinoIcon onClick={randomFamilySituation} />,
      ...
      },
      {
        ...
        placeholder: "Race",
        onChange: changeSelect,
        value: generalInfos.race || "Race",
        startDecorator: <CasinoIcon onClick={randomRace} />,
        options: RACES,
      },
      {
        name: "type",
        ...
        startDecorator: <CasinoIcon onClick={randomType} />,
        disabled: !needsType,
        options: typesList,
      },
      {
        ...
        placeholder: "Origine",
        onChange: changeSelect,
        value: generalInfos.origin || "Origine",
        startDecorator: <CasinoIcon onClick={randomOrigin} />,
        options: ORIGINS,
      },
      {
        name: "socialStatus",
        ...
        startDecorator: <CasinoIcon onClick={randomSocialStatus} />,
      ...
      },
      {
        ...
        startDecorator: <CasinoIcon onClick={randomClass} />,
  ...
  return (
    <CreateCharacterCard
      ...
      buttonText="Enregistrer les informations générales"
      content={content}
      randomAll={randomAll}
    />
  );
